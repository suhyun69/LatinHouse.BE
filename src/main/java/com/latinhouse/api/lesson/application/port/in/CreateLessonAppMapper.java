...
public class CreateLessonAppMapper {

    private CreateLessonAppMapper() {}

    public static Lesson toDomain(CreateLessonAppRequest request) {
    ...
    public static CreateLessonAppResponse toAppResponse(Lesson lesson) {
        return CreateLessonAppResponse.builder()
                .id(lesson.getId())
                .build();
    }
