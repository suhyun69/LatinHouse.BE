    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/lessons/*").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/lesson/*").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/order").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/orders").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/coupon/template").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/coupon").permitAll()
                        .requestMatchers(HttpMethod.PATCH, "/api/coupon/*").permitAll()
